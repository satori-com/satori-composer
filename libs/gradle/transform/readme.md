[![Maven](https://img.shields.io/nexus/s/https/oss.sonatype.org/com.satori/satori-libs-gradle-transform.svg)](https://oss.sonatype.org/content/repositories/snapshots/com/satori/satori-libs-gradle-transform/0.5.75-SNAPSHOT/)
...
buildscript{
  ...
  dependencies {
    classpath "com.satori:satori-libs-gradle-docker:0.5.75-SNAPSHOT"
  }
}
